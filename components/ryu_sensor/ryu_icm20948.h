...
class ICM20948{
    public:
       // 복사 방지
        ...
        static inline constexpr uint8_t  ADDR_GND =  0x68; // AD0핀이 GND일 때 0x68, VCC일 때 0x69
        static inline constexpr uint8_t  ADDR_VCC =  0x69; // AD0핀이 GND일 때 0x68, VCC일 때 0x69
